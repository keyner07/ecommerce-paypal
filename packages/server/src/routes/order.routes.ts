...
import { createOrder, getOrder, getOrders, deleteOrder, paymentMethod} from '../controllers/order.controller';
...
class OrderRoutes {
    ...
    protected routes(): void {
        ...
        this.router.put('/:id/pay', passport.authenticate('jwt', { session: false }), paymentMethod);
    }
}
